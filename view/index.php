        ...
        <div class="section competences nomargin nopadding">
            <div class="container-fluid clearfix">
                ...
                <div class="row center bottommargin">
                    ...
                    <i style="position:relative; top:-20px;" class="devicon-photoshop-line colored"></i>
                    <i style="position:relative; top:-20px;" class="devicon-illustrator-line colored"></i>
                    <svg version="1.1"
                         id="pr"
                         xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <img style="vertical-align: baseline;" src="/public/images/icons/3dsmax.png" alt="3D Studio Max" />
                </div>
                <div class="row clearfix common-height col-padding">
                    <div class="divider divider-border divider-center nomargin">
                        <i class="icon-terminal"></i>
