        ...
        <footer id="footer" class="dark">
            ...
            <div id="copyrights">
                ...
                <div class="container clearfix">
                    ...
                    <div class="col_half">
                        Copyrights &copy; 2016-2017 Axel Floquet-Trillot - Tous droits réservés<br>
                        <div class="copyright-links"><a href="#">Terms of Use</a> / <a href="#">Privacy Policy</a></div>
                    </div>

                    <div class="col_half col_last tright">
                        <div class="fright clearfix">
                            <a href="/contact" class="social-icon si-rounded si-small si-borderless si-email3">
                        ...
                        <i class="icon-envelope2"></i> contact@axelfloquet.fr <span class="middot">&middot;</span> <i class="icon-headphones"></i> +33 6 19 64 09 77 <span class="middot">&middot;</span> <i class="icon-skype2"></i> Axel FT
                    </div>
